...
export function Card({ itemImg, itemName, itemPrice, itemDescription,itemRoute, userStatus,...rest}){
    ...
    <Container>
      {userStatus === 'user' &&
        (<Item>
          ...
          <svg className='actionButton' width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {userStatus === 'admin' &&
        (<Item>
          ...
          <p className='itemDescription'>{itemDescription}</p>
          <span>{itemPrice}</span>
          <svg className='actionButton' width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
